...
class DRLEnvironment(Node):
    ...
    *******************************************************************************"""
    ...
    def filtered_lidar(self, lidar):
        input_diff = len(lidar) - REAL_N_SCAN_SAMPLES
        
        if input_diff < 0:
            lidar_sensor_input = self.sensor_value_addition(lidar, abs(input_diff))
        elif input_diff > 0:
            lidar_sensor_input = self.sensor_value_deletion(lidar, abs(input_diff))
        else:
