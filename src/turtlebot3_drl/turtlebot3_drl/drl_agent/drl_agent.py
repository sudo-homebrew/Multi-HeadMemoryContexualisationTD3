...
from ..common.settings import ENABLE_VISUAL, ENABLE_STACKING, OBSERVE_STEPS, MODEL_STORE_INTERVAL, GRAPH_DRAW_INTERVAL, ENABLE_MANUAL_ACTION, ENABLE_IMITATE_ACTION
        ...
        while (True):
            ...
            while not episode_done:
                if self.training and self.total_steps < self.observe_steps:
                    ...
                    elif ENABLE_IMITATE_ACTION:
                        action = self.model.get_action_imitate(state)
                    else:
