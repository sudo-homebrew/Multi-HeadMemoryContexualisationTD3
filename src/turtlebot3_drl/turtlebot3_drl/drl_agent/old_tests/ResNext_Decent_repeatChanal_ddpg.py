...
# ResNext_Decent_repeatChanal_ddpg.py
...
class Actor(Network):
    def __init__(self, name, state_size, action_size, hidden_size):
        ...
        self.fa3 = nn.Linear(int(ResNext_output_size / 2), int(ResNext_output_size / 4))
        self.fa4 = nn.Linear(int(ResNext_output_size / 4), int(ResNext_output_size / 8))
        self.fa5 = nn.Linear(int(ResNext_output_size / 8), int(ResNext_output_size / 16))
        self.fa6 = nn.Linear(int(ResNext_output_size / 16), action_size)
...
#        self.apply(super().init_weights)
    ...
    def forward(self, states, visualize=False):
        ...
        x3 = torch.sigmoid(self.fa3(x2))
        x4 = torch.sigmoid(self.fa4(x3))
        x5 = torch.sigmoid(self.fa5(x4))
