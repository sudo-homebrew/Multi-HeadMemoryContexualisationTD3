...
class Actor(Network):
    def __init__(self, name, state_size, action_size, hidden_size):
        ...
        self.fa3 = nn.Linear(hidden_size, int(hidden_size / 2))
        self.fa4 = nn.Linear(int(hidden_size / 2), int(hidden_size / 4))
        self.fa5 = nn.Linear(int(hidden_size / 4), int(hidden_size / 8))
        self.fa6 = nn.Linear(int(hidden_size / 8), action_size)
