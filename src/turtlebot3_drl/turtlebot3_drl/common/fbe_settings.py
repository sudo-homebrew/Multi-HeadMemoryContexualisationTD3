...
EPISODE_TIMEOUT_SECONDS = 10000    # Number of seconds after which episode timeout occurs

TOPIC_SCAN = 'scan'
TOPIC_VELO = 'cmd_vel'
TOPIC_ODOM = 'odom'

EPISODE_TIMEOUT_SECONDS     = 300    # Number of seconds after which episode timeout occurs
ARENA_LENGTH                = 4.2   # meters
ARENA_WIDTH                 = 4.2   # meters
SPEED_LINEAR_MAX            = 0.26  # m/s
SPEED_ANGULAR_MAX           = 1.8   # rad/s
...
REAL_SPEED_LINEAR_MAX       = 0.2  # in m/s
...
STEP_TIME       = 0.0      # Delay between steps, can be set to 0
